...
function getWinners(getFinals) {
    ...
    const filterWinners = getFinals(fifaData).filter((item) => { //filtering through my finals data 
...
function getWinnersByYear(getWinners, getYears) {
    let wcWins = new Set();
    let winYears = getYears(getFinals); // an array of years of the finals
    let countries = getWinners(getFinals); // an array of countries of the finals
